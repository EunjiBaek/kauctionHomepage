...
namespace KA.Web.Admin.Services
{
    public class CommonService
    {
        ...
        public CommonService(IContentRepository contentRepository, ICommonRepository commonRepository, IHttpContextAccessor httpContextAccessor)
        {
        ...
        public bool IsMobile(string value = "")
        {
            try
            {
                string u = string.IsNullOrWhiteSpace(value) ? httpContextAccessor.HttpContext.Request.Headers["User-Agent"].ToString() : value;
        ...
        /// </summary>
        /// <returns></returns>
        public IEnumerable<Menu> GetMenus(string type, int memUid)
        {
            return commonRepository.GetMenus(type, "K", memUid);
        }

        public void RedirectLogin()
        {
            httpContextAccessor.HttpContext.Response.Redirect("/Home/Login");
        }

        public void RedirectLogout()
        {
            httpContextAccessor.HttpContext.Response.Redirect("/Home/Logout");
        }
        ...
        {
            return contentRepository.GetBoardInfos(mode);
        }
